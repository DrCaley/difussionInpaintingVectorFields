...
def get_death_message():
    messages = [
        ...
        "🌪️ model tried to predict the currents and got caught in one",
        "🔮 model foresaw its own death, and still couldn’t prevent it",
        "📦 model has ascended to the Big Checkpoint in the Sky",
        "🕯️ model’s torch has gone out... literally",
        "🤪 model looked at currents for too long that it went insane!",
        "🧑‍⚖️ model had jury duty",
        "🚽 model had to take a dookie and just... never came back",
        "💀 model had 0 KP at 20 minutes and still said 'team diff'",
