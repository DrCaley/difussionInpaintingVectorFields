...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv12 = PConv2d(67, 3, 3, 1, 1)

        self.batchNorm1 = nn.BatchNorm2d(64)
        self.batchNorm2 = nn.BatchNorm2d(128)
        self.batchNorm3 = nn.BatchNorm2d(256)
        self.batchNorm4 = nn.BatchNorm2d(512)
        self.batchNorm8_1 = nn.BatchNorm2d(512)
    ...
    def forward(self, input, input_mask):
        ...
        batchNorm9_output =  self.batchNorm4(conv9_output)
        leakyRelu1 =  self.leakyRelu(batchNorm9_output)
        # print(conv9_output.shape)
        # 4x4

        upsample2 =  self.upsample(leakyRelu1)
        upsample2_mask =  self.upsample(conv9_output_mask)
        ...
        upsample3_mask =  self.upsample(conv10_output_mask)
